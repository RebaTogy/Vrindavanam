...
'cooking-grade-ghee': {
    ...
    'cashew-with-skin': {
        ...
        description: 'Naturally processed cashew kernels with skin intact. Rich in healthy fats, protein, and minerals. Estate-sourced from traditional harvesting methods. Perfect for healthy snacking and culinary use.',
    },
    'cashew-without-skin': {
        ...
        backHref: 'cashew.html',
        description: 'Premium grade cashew kernels with skin removed. Ready to eat, creamy texture, and nutrient-rich. Hand-selected estate quality kernels for the finest taste and texture.',
    },
};
...
if (select) {
    ...
    if (dbProducts.length > 0) {
        ...
        const w = parseFloat(first.weight.replace(/[^\d.]/g, ''));
        baseWeight = first.weight.toLowerCase().includes('kg') ? w * 1000 : w;
